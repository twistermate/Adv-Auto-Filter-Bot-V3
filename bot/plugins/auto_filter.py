...
async def auto_filter(bot, update):
    ...
    if filters:
        results.append(
                [
                    InlineKeyboardButton("⚠️ ERROR CLICK HERE ⚠️", url="https://t.me/closechapters2_0")
                ]
            )
